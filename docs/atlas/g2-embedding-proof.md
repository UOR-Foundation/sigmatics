...
- **Conway & Smith**: *On Quaternions and Octonions* (octonion automorphisms)
- **Baez**: *The Octonions* (expository article on G₂)
- **Wilson**: *Finite Simple Groups* (PSL(2,7) structure)
